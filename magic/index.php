...
define('CAMPAIGN_ID', "05551fa3a442e4976ff76213d615a450");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '8fecd3e613b380054b6b4f693ce5137b');
define('MP_PARAM_NAME', '_et_sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '6abee2a9ad73dd06206a3982295426e8');
define('CHECK_MCPROXY_VALUE', 'cc3cb5afb36686c41460fa65d6069bae83675a1e87e977432c3483307cf3344f');
